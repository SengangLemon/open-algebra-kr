...
$\F_{q^n}/\F_q$는 분리확장이므로 분리차수 정리에 의해 $\F_q$-매장
\[
  \F_{q^n}\longrightarrow\overline{\F_q}
\]
은 정확히 $n$개이다. 이러한 매장의 상은 원소가 $q^n$개인 $\overline{\F_q}$의 부분체이다. 한 대수적 폐포 안에서 원소가 $q^n$개인 부분체는 하나뿐이므로 그 상은 다시 $\F_{q^n}$이다. 따라서 모든 매장은 $\F_q$-자동동형이고
\[
  |\Aut_{\F_q}(\F_{q^n})|=n.
\]
이미 $\Frob_q$의 거듭제곱으로 서로 다른 $n$개의 자동동형을 얻었으므로 이것들이 전부이다.
\end{proof}
