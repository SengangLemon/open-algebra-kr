...
\[
  \texttt{https://github.com/SengangLemon/open-algebra-kr/issues}
\]
...
\texttt{notes/reviews/volume-03-external-review-guide.md}에 정리되어 있다.

\section*{현재 상태}

이 판본은 학습과 검토를 위한 공개 초고이다. 외부 검토에서 접수된 지적은 공개 이슈와 수정 커밋으로 추적하며, 독립 검토와 전문 교열·디자인 검수가 끝난 뒤에만 릴리스 후보로 승격한다.
