...
\end{array}
\]
이 그림은 엄밀한 선수관계를 모두 표시한 것이 아니라 학습의 중심 경로를 요약한다.
...
Chapter 1--8에는 각 장마다 30개의 문제가 있다.
\begin{description}[style=nextline,leftmargin=0pt]
  \item[A. 계산과 기본 판정]
...
\end{description}
전권에는 연습문제 240개와 선별 상세 풀이 120개가 있다. 처음 읽을 때에는 각 절의 이해 점검과 A 문제를 먼저 풀고, 두 번째 읽기에서 B와 C 문제로 넘어가는 편이 좋다.
