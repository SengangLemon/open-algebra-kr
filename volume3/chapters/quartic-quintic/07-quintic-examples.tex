...
\[
  ...
  f_S(-a)=2+\frac{16a}{5}>0.
\]
무한대에서의 부호와 함께 보면 $f_S$는 정확히 세 실근과 한 쌍의 비실 켤레근을 갖는다. 복소켤레는 세 실근을 고정하고 비실 두 근을 맞바꾸므로 갈루아군에 전치가 들어간다. $5$-순환과 전치가 생성하는 추이적 부분군은 $S_5$이므로
\[
  G\cong S_5.
\]
\end{proof}
