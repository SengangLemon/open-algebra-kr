...
\]
과 행렬식의 곱셈성에서 따른다. 일반 형식적 차수 공식은 모든 계수를 독립인 변수로 둔 보편 다항식환에서 먼저 증명할 수 있다. 이 환은 정역이므로 분해체에서 근 공식을 적용하면 곱셈성이 바로 나오고, 얻어진 정수계수 다항식 항등식을 임의의 $R$로 특수화하면 된다. 첫 번째 변수에 관한 공식은
\[
