...
\[
  ...
  \qquad 0\le\nu_i<i
\]
를 기저로 갖는다. 다음으로 $s_1,\dots,s_{n-1},T_n$이 $R$ 위에서 대수적으로 독립임을 확인한다. 실제로 단항식
\[
  s_1^{a_1}\cdots s_{n-1}^{a_{n-1}}T_n^b
\]
의 사전식 최고 단항식 지수는
\[
  (a_1+\cdots+a_{n-1},
   ...
   \dots,a_{n-1},b)
\]
이고, 이 지수벡터는 $(a_1,\dots,a_{n-1},b)$를 유일하게 결정한다. 따라서 서로 다른 단항식의 최고항은 상쇄될 수 없다. 특히
\[
  R[s_1,\dots,s_{n-1},T_n]
  =R[s_1,\dots,s_{n-1}][T_n]
\]
