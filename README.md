...
> **Status: Volume 1 Draft 0.3 검수 완료 · Volume 2 Draft 0.4 유한체까지 1차 검수 완료**

Volume 1의 군론·환론·다항식론은 첫 번째 수학·통합 검수 패스를 마쳤습니다. Volume 2에는 표수와 최소다항식, 분해체와 대수적 폐포, 분리성과 순수비분리 확장, 유한체까지의 원고·문제·선별 풀이가 들어갔고 해당 범위의 첫 번째 검수 패스를 마쳤습니다. 두 권 모두 아직 정식 출판본은 아닙니다.
...
2. **Volume 2: 대수적 체확장** — Draft 0.4, Chapter 4까지 1차 검수 완료
